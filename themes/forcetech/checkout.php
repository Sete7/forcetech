                        ...
                        <div class="row">
                            <div class="column column-12">
                                <div class="cc-selector">
                                    ...
                                    <label class="drinkcard-cc visa" for="payment_card"><span>Cartão</span></label>

                                    <input id="payment_boleto" class="payment_boleto" name="radio_pagamento" type="radio"/>
                                    <label class="drinkcard-cc boleto"  for="payment_boleto"><span> Boleto</span></label>

                                    <input id="payment_debito" class="payment_debito" name="radio_pagamento"  type="radio"/>                              
                                    <label class="drinkcard-cc debito" for="payment_debito"><span>Transferência</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
